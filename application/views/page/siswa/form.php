        ...
        <form id="form_siswa" class="form-horizontal form-label-left">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" name="nik_siswa" class="form-control" value="<?= isset($siswa) ? $siswa['nik_siswa'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" name="nama_siswa" class="form-control" value="<?= isset($siswa) ? $siswa['nama_siswa'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="no_hp_siswa" value="<?= isset($siswa) ? $siswa['no_hp_siswa'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="email_siswa" value="<?= isset($siswa) ? $siswa['email_siswa'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="tinggi_siswa" value="<?= isset($siswa) ? $siswa['tinggi_siswa'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="berat_siswa" value="<?= isset($siswa) ? $siswa['berat_siswa'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="tags_4" type="text" name="suku_siswa" class="tags form-control" value="<?= isset($siswa) ? $siswa['suku_siswa'] : '' ?>" />
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="tempat_lahir" value="<?= isset($siswa) ? $siswa['tempat_lahir'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="pekerjaan" value="<?= isset($siswa) ? $siswa['pekerjaan'] : '' ?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="birthday" name="tgl_ktp" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="<?= isset($siswa) ? $siswa['tgl_ktp'] : '' ?>">
              <script>
                function timeFunctionLong(input) {
                  setTimeout(function() {
                    input.type = 'text';
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="tags_1" type="text" name="bahasa_asing" class="tags form-control" value="<?= isset($siswa) ? $siswa['bahasa_asing'] : '' ?>" />
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="tags_2" type="text" name="bahasa_daerah" class="tags form-control" value="<?= isset($siswa) ? $siswa['bahasa_daerah'] : '' ?>" />
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="tags_3" type="text" name="prestasi" class="tags form-control" value="<?= isset($siswa) ? $siswa['prestasi'] : '' ?>" />
              <div id="suggestions-container-3" style="position: relative; float: left; width: 250px; margin: 10px;"></div>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="asal_polda">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="asal_polres">
      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" id="form_wali">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="birthday" class="date-picker form-control" name="tgl_lahir_wali" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="<?= isset($siswa) ? $siswa['tgl_lahir_wali'] : '' ?>">
              <script>
                function timeFunctionLong(input) {
                  setTimeout(function() {
                    input.type = 'text';
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <textarea id="message" required="required" class="form-control" name="alamat_kantor_wali" data-parsley-trigger="keyup" data-parsley-minlength="5" data-parsley-maxlength="500" data-parsley-minlength-message="Come on! You need to enter at least a 5 caracters long comment.." data-parsley-validation-threshold="10"><?= isset($siswa) ? $siswa['alamat_kantor_wali'] : '' ?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Nama Kantor Wali</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_kantor_wali'] : '' ?>" name="nama_kantor_wali">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jabatan Wali</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jabatan_wali'] : '' ?>" name="jabatan_wali">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Gol. Kerja Wali</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['gol_kerja_wali'] : '' ?>" name="gol_kerja_wali">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jenis Kerja Wali</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jns_kerja_wali'] : '' ?>" name="jns_kerja_wali">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Kel. Kerja Wali</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['kel_kerja_wali'] : '' ?>" name="kel_kerja_wali">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">No. HP Wali</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['no_hp_wali'] : '' ?>" name="no_hp_wali">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="nama_wali" value="<?= isset($siswa) ? $siswa['nama_wali'] : '' ?>">
            </div>
          </div>
          <div class="ln_solid"></div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="birthday" class="date-picker form-control" name="tgl_lahir_ibu" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="<?= isset($siswa) ? $siswa['tgl_lahir_ibu'] : '' ?>">
              <script>
                function timeFunctionLong(input) {
                  setTimeout(function() {
                    input.type = 'text';
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <textarea id="message" required="required" class="form-control" name="alamat_kantor_ibu" data-parsley-trigger="keyup" data-parsley-minlength="5" data-parsley-maxlength="500" data-parsley-minlength-message="Come on! You need to enter at least a 5 caracters long comment.." data-parsley-validation-threshold="10"><?= isset($siswa) ? $siswa['alamat_kantor_ibu'] : '' ?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Nama Kantor Ibu</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_kantor_ibu'] : '' ?>" name="nama_kantor_ibu">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jabatan Ibu</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jabatan_ibu'] : '' ?>" name="jabatan_ibu">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Gol. Kerja Ibu</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['gol_kerja_ibu'] : '' ?>" name="gol_kerja_ibu">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jenis Kerja Ibu</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jns_kerja_ibu'] : '' ?>" name="jns_kerja_ibu">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Kel. Kerja Ibu</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['kel_kerja_ibu'] : '' ?>" name="kel_kerja_ibu">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">No. HP Ibu</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['no_hp_ibu'] : '' ?>" name="no_hp_ibu">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="nama_ibu" value="<?= isset($siswa) ? $siswa['nama_ibu'] : '' ?>">
            </div>
          </div>
          <div class="ln_solid"></div>
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="status_bapak">
                <option value="Hidup">Hidup</option>
                <option value="Meninggal">Meninggal</option>
              </select>
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input id="birthday" class="date-picker form-control" name="tgl_lahir_bapak" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="<?= isset($siswa) ? $siswa['tgl_lahir_bapak'] : '' ?>">
              <script>
                function timeFunctionLong(input) {
                  setTimeout(function() {
                    input.type = 'text';
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <textarea id="message" required="required" class="form-control" name="alamat_kantor_bapak" data-parsley-trigger="keyup" data-parsley-minlength="5" data-parsley-maxlength="500" data-parsley-minlength-message="Come on! You need to enter at least a 5 caracters long comment.." data-parsley-validation-threshold="10"><?= isset($siswa) ? $siswa['alamat_kantor_bapak'] : '' ?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Nama Kantor Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_kantor_bapak'] : '' ?>" name="nama_kantor_bapak">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jabatan Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jabatan_bapak'] : '' ?>" name="jabatan_bapak">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Gol. Kerja Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['gol_kerja_bapak'] : '' ?>" name="gol_kerja_bapak">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jenis Kerja Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jns_kerja_bapak'] : '' ?>" name="jns_kerja_bapak">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Kel. Kerja Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['kel_kerja_bapak'] : '' ?>" name="kel_kerja_bapak">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">No. HP Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['no_hp_bapak'] : '' ?>" name="no_hp_bapak">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Agama Bapak</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="agama_bapak">
                <option value="Islam">Islam</option>
                <option value="Kristen">Kristen</option>
                <option value="Hindu">Hindu</option>
                <option value="Buddha">Buddha</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="nama_bapak" value="<?= isset($siswa) ? $siswa['nama_bapak'] : '' ?>">
            </div>
          </div>
          <div class="ln_solid"></div>
        </form>
      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" id="form_pendidikan">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="nim" value="<?= isset($siswa) ? $siswa['nim'] : '' ?>">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_prodi'] : '' ?>" name="nama_prodi">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Nama Perguruan Tinggi</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_pt'] : '' ?>" name="nama_pt">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">IPK</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['ipk'] : '' ?>" name="ipk">
            </div>
          </div>
          <div class="ln_solid"></div>
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['rata_rapor'] : '' ?>" name="rata_rapor">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Pendidikan umum akhir</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['dikum_akhir'] : '' ?>" name="dikum_akhir">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Jurusan SLTA</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['jurusan'] : '' ?>" name="jurusan">
            </div>
          </div>
          <div class="ln_solid"></div>
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['rata_un_sma'] : '' ?>" name="rata_un_sma">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Tahun lulus SMA</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['thn_lulus_sma'] : '' ?>" name="thn_lulus_sma">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Provinsi SMA</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="provinsi_sma">
                <?php foreach ($provinsi as $p => $pn): ?>
                  <option value="<?= $p ?>"><?= $pn ?></option>
                <?php endforeach ?>
              </select>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="kab_kota_sma">
                <?php foreach ($kota as $p => $pn): ?>
                  <option value="<?= $p ?>"><?= $pn ?></option>
                <?php endforeach ?>
              </select>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_sma'] : '' ?>" name="nama_sma">
            </div>
          </div>
          <div class="ln_solid"></div>
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['rata_un_smp'] : '' ?>" name="rata_un_smp">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Tahun lulus SMP</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['thn_lulus_smp'] : '' ?>" name="thn_lulus_smp">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Provinsi SMP</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="provinsi_smp">
                <?php foreach ($provinsi as $p => $pn): ?>
                  <option value="<?= $p ?>"><?= $pn ?></option>
                <?php endforeach ?>
              </select>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="kab_kota_smp">
                <?php foreach ($kota as $p => $pn): ?>
                  <option value="<?= $p ?>"><?= $pn ?></option>
                <?php endforeach ?>
              </select>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nama_smp'] : '' ?>" name="nama_smp">
            </div>
          </div>
          <div class="ln_solid"></div>
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['rata_un_sd'] : '' ?>" name="rata_un_sd">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Tahun lulus SD</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['thn_lulus_sd'] : '' ?>" name="thn_lulus_sd">
            </div>
          </div>
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Provinsi SD</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="provinsi_sd">
                <?php foreach ($provinsi as $p => $pn): ?>
                  <option value="<?= $p ?>"><?= $pn ?></option>
                <?php endforeach ?>
              </select>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <select class="form-control" name="kab_kota_sd">
                <?php foreach ($kota as $p => $pn): ?>
                  <option value="<?= $p ?>"><?= $pn ?></option>
                <?php endforeach ?>
              </select>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="nama_sd" value="<?= isset($siswa) ? $siswa['nama_sd'] : '' ?>">
            </div>
          </div>
          <div class="ln_solid"></div>
        </form>
      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" id="form_seleksi">
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nosis_panjang'] : '' ?>" name="nosis_panjang">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nilai_jasmani'] : '' ?>" name="nilai_jasmani">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nilai_psi'] : '' ?>" name="nilai_psi">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nilai_uji_akademik'] : '' ?>" name="nilai_uji_akademik">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['nilai_akhir'] : '' ?>" name="nilai_akhir">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" value="<?= isset($siswa) ? $siswa['ranking'] : '' ?>" name="ranking">
            </div>
          </div>
    ...
    <script type="text/javascript" charset="utf-8" defer>
      ...
      $('#submitBtn').click((e) => {
        ...
        let cs = {};
        for (c in concats) {
          console.log(concats[c].name);
          cs[concats[c].name] = concats[c].value;
        }

        $.ajax({
          url: 'http://localhost/spn/index.php/Siswa/save_siswa',
          type: 'POST',
          dataType: 'json',
          data: cs,
        })
        .done(function(data_save) {
          $.ajax({
            url: 'http://localhost/spn/index.php/Siswa/up_image',
            type: 'POST',
            processData: false,
            contentType: false,
            dataType : 'json',
          ...
          .done(function(data_image) {
            ...
            $.ajax({
              url: 'http://localhost/spn/index.php/Siswa/update_image/'+data_save,
              type: 'POST',
